...
def fire_bullet(ai_settings,screen,ship,bullets):
    """Fire a bullet if limit not reahed yet."""
...
def update_screen(ai_settings,screen ,stat,ship,aliens,bullets,play_button):
    """Update the screen each pass through the loop"""
